...
class Circle {
  ...
  writeText(ctx) {
    ...
    const fontSize = `${_theme.default.fontSize}pt`;
    const ySpacing = _theme.default.fontSize / 2;
...
function drawBinaryTree(root, canvasElement, options = {}) {
  ...
  const canvasComponent = canvasMap.get(canvasElement) || new _Canvas.default(canvasElement);
  canvasMap.set(canvasElement, canvasComponent);

  switch (type) {
    case _VisualizationType.VisualizationType.PRETTY:
      (0, _drawPrettyBinaryTree.default)(root, canvasComponent, {
        maxHeight,
        maxWidth
      });
      break;
    ...
    case _VisualizationType.VisualizationType.EXPANDABLE:
      (0, _drawExpandableBinaryTree.default)(root, canvasComponent, {
        maxHeight,
        maxWidth
      });
      break;
    ...
    default:
      (0, _drawSimpleBinaryTree.default)(root, canvasComponent, {
        maxHeight,
        maxWidth
      });
      break;
...
},{"./tree":"../node_modules/binary-tree-visualizer/lib/tree/index.js","./canvas":"../node_modules/binary-tree-visualizer/lib/canvas/index.js","./enumns":"../node_modules/binary-tree-visualizer/lib/enumns/index.js","./config":"../node_modules/binary-tree-visualizer/lib/config/index.js"}],"../src/app.js":[function(require,module,exports) {
"use strict";
...
(0, _binaryTreeVisualizer.setTheme)({
  textFont: "Poppins",
  radius: 31,
  fontSize: 18,
  strokeColor: "#2a832f",
...
nodesValues.addEventListener("keyup", function (e) {
  if (e.key === "Enter") {
    inputToList(e);
  }
});
...
function inputToList(e) {
  ...
  if (nodesValues.value == "") {
    ...
    if (list.some(isNaN)) {
      result.style.display = "none";
      error.style.display = "block";
      error.innerHTML = "Please Check All The Rules First , Only Numbers Are Allowed !!";
      setTimeout(function () {
        error.innerHTML = "";
      }, 4000);
      return;
    ...
    if (hasDuplicates(list)) {
      var dupli = tellsDuplicates(list);
      message.innerText = "YOUR FINAL BINARY SEARCH TREE : \nYou Have Entered Some Duplicates Also : ";
      dupli.forEach(function (elem) {
...
function buildATree(list) {
  ...
  (0, _binaryTreeVisualizer.drawBinaryTree)(root, document.querySelector("canvas"));
}
